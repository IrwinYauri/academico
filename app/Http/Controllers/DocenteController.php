...
class DocenteController extends Controller
{
 ...
 return $data1;
  ...
  { 
    ...
    $coddocentex=2;//$_SESSION['coddocentex'];
 ...
 public function verhorario( $coddocentex,$semestre)
  { 
     ...
     //   $nro=request('nro');
       ...
       $extension = $request->file('file')->extension();
        ...
        echo $filenom;
           ...
           */
          //$pag="1";
           return view('docente.pdfcargahorario');
        //  $pdf=PDF::loadView('docente.pdfcargahorario');
          //return $pdf->download('reportehorario.pdf');
           }
