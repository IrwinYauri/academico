  ...
  <div class="container table-condensed">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="cerrarAbrirN();"><i class="fa fa-save"></i>&nbsp;Cerrar y Abrir Nuevo Semestre</button>
    ...
    <script type="text/javascript">
      ...
      { 
        ...
        {
          var r = confirm("¿Está seguro que desea cerrar el semestre {{$semestre_act->sem_nombre}} y aperturar uno nuevo?");
          if (r == true) 
          {
