                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><i class="fas fa-user-cog"></i> INTRANET ADMIN</h1>
                                    </div>
                                    <form class="user" action="{{ asset('admin/validaradmin')}}" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                               aria-describedby="dni"
                                                placeholder="ingrese usuario" id="userx" name="userx">
                                                @csrf
                                        </div>
                                        <div class="form-group">
