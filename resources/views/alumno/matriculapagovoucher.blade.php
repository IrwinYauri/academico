...
<<<<<<< HEAD
    <div class="card-header py-3 colorlista" >
        <h6 class="m-0 font-weight-bold ">
            
            <a class="btn btn-dark  btn-lg" style="background-color: black">1</a>    Nota: Subir una copia del voucher(máx 4MB). Puede ser un archivo de imagen o pdf.
        </h6>
...
<p>Por el tipo de matrícula que le corresponde, usted debe realizar el pago de S/. 25.00. Puede realizar el deposito de la siguiente manera:</p>
<ul>
...
<strong style="font-style: italic;">Horarios de Atención: Lun a Vie. 08:00 am a 01:00 pm | 03:00 pm a 06:00 pm</strong>  
</p>
    </td>
    </tr>
=======
