...
<div align="right">
    <a class="btn btn-primary" href="docente/rptcargahorario" style="display: none"> IMPRIMIR </a>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3" style="background-color:navy)">
            <h6 class="m-0 font-weight-bold text-dark-400">
                <i class="fa fa-calendar fa-2x"></i>ASISTENCIA SEGUN HORARIO DE CLASES
                {{ left($semestreactual, 4) }}-{{ right($semestreactual, 1) }}
