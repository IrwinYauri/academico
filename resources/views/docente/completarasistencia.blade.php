    ...
    <table>
      ...
      @foreach($listahora as $horario)      
        ...
        <tr style="color:#505050">
          <td>
            <button type="button"  class="btn btn-primary" onclick="mostrarobjeto('tn{{$n}}')">ver </button> 
            {{ $n }} {{ $horario->sec_iNumero }}::{{ $horario->dia_vcCodigo }}::{{ left($horario->tipodictado,1)}}::{{ $codcur=$horario->cur_vcCodigo }}
