               ...
               // echo cambiarcolorpromedio($tpro);
                ...
                $mibloqueo="";
                 ...
                 echo "<td><input type='text' size=2 disabled style='background-color:#cdcdcd;'  
                  ...
                  value='".$nota->aplaz."'
                  onkeyup='jsnotascolor(this);
                  grabarnotasaplazado(this,".$nota->cur_iCodigo.",".$nota->alu_iCodigo.");
                    vermensaje();'>
                      </td>";
...
<script>
  ...
  <div class="card mb-4">
        <div class="card-header bg-danger text-black" style='background-color:rgb(88, 25, 236);color:white;'>
            REPORTE DE NOTAS APLAZADOS
            <div id="ohsnap" ></div>
            </div>
        <div class="card-body">
            <table>
            ...
            @endphp
            <tr>
            <td><button type="button"  class="btn btn-danger" href="#"
...
<script>
  function grabarnotasaplazado(idnota,idcurso,idalumno)
  {//alert(id.value);
