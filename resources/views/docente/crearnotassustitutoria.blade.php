...
<h5 style="color:Navy">REGISTRO DE NOTAS SUSTITUTORIA</h5>
<table class="table table-striped">
  <thead>
    <tr style="background-color: #4b1155;color:white">
        <td></td>
        <td>COD-CURSO</td>
        <td>CURSO</td>
        <td>SECCION</td>
    ...
    @foreach ($miscursosgrupo as $listacur)
        ...
        <tr>
            <td><button type="button" class="btn btn-success " onclick="mostrarcursox('{{ $coddocentex }}',
                          ...
                          style=" background-color: #4b1155; border-color: #2F3E48;">VER
                </button>
            </td>
...
<script>
    function mostrarcursox(coddocente, semestre, codcurso, curso, escuela) {
     ...
     $("#micontenido").html(
      ...
      $.ajax({
            url: "docente/crearnotassustitutoriacurso",
