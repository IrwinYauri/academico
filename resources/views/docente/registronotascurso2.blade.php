...
$escuela = '';
$curso = '0';
if (isset($_REQUEST['coddocentex'])) {
    $coddocentex = $_REQUEST['coddocentex'];
    $sem = $_REQUEST['sem'];
            ...
            <table>
                <tr>
                    ...
                    <td rowspan="3">
                        ...
                        <button class="btn btn-primary w-100" type="button" onclick="vercursoreg()">VER LISTA DE CURSOS
                        </button><br>
                        <button class="btn btn-success w-100" type="button"
                            onclick="xverregistro('{{ $codcurso }}','{{$sem}}','{{$coddocentex}}')">
                            <i class="fas fa-file-excel"> </i> EXPORTA XLS</button>
