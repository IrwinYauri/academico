...
$miscursos=sqlvercursos($semestreactual,$coddocentex);
@endphp
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary"
                            ...
                            <a class="btn btn-success"
                                onclick="vercriteriox('{{ $semestreactual }} ','{{$listacur->cur_iCodigo }} ');">VER CRITERIOS</a>
                        </td>
                    </tr>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-content">
          <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
                  <i class="fa fa-book fa-2x"></i> CONFIGURACION DE CRITERIOS DE EVALUACION
              </h6>
          </div>
          ...
          <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" onclick='$("#myModal").modal("hide");''>CERRAR</button>
          </div>
      </div>
...
<script>
    function vercursoscriterio(idcurso, curso, seccion, semestre, estado) {
        if (estado === "PENDIENTE") { //location.href=""
    ...
    function vercriteriox(semestre,codcurso) { //actas/veractas?xcod=2
      $("#myModal").modal("show");
        ...
        $.ajax({
            url: "docente/silabusevaluaciondetallex",
            success: function(result) {
                //   alert(result)
                // $("#modaleditar").modal('show');
                $("#mirespuesta").html(result);
...
<script>
    ...
    function vernrounidad(elemento) { //r=elemento.value;
        r = elemento;
        // alert(r)
        switch (r * 1) {
            case 1:
    ...
    function ocultarnrounidad() { // document.getElementById("unidad11").style.display="none";
...
<div class="card-body">
    ...
    <div id="openModal" class="modalDialog">
        <div>
            ...
            <div class="row" style="background-color: navy;color:white">
                &nbsp &nbsp<i class="fa fa-book fa-2x"></i>
                <h5 class="modal-title " id="exampleModalLongTitle"> CONFIGURAR CRITERIOS DE EVALUACION</h5>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-condensed" id="dataTablex" width="100%" cellspacing="0">
                    <thead>
    ...
    pesoevaluacion5*/
        ...
        function reiniciar() { //document.getElementById('seccion').value
